...
import 'package:sixvalley_vendor_app/view/base/call_notifier.dart';
import 'package:sixvalley_vendor_app/view/base/custom_edit_dialog.dart';
import 'package:sixvalley_vendor_app/view/screens/home/widget/bar_chart.dart';
  ...
  Future<void> _loadData(BuildContext context, bool reload) async {
    ...
    if (user != null) {
      ...
      FirebaseDatabase.instance
          ...
          .onValue
          .listen((event) {
        var info = CallInfo.fromMap(event.snapshot.value['call']);
        if (info.status == Status.calling && info.userId != callId) {
          callId = info.userId;
          Future.delayed(Duration.zero, () {
            var key = UniqueKey();
            showOverlayNotification((context) {
              return CallNotifier(callerInfo: info, key: key);
            }, key: key, duration: Duration(seconds: 15));
          });
        }
      });
    }
